        ...
        bool                 a_homoOnly)
{
  ...
  newOp = new NWOEBViscousTensorOp(EBLevelGrid(), eblgMGLevel, EBLevelGrid(), eblgCoarMG,
...
AMRnewOp(const ProblemDomain& a_domainFine)
{
  ...
  NWOEBViscousTensorOp* newOp = NULL;
  newOp = new NWOEBViscousTensorOp(eblgFine, eblgMGLevel, eblgCoar, eblgCoarMG,
...
void
NWOEBViscousTensorOpFactory::
AMRreclaim(NWOEBViscousTensorOp* a_reclaim)
{
  delete a_reclaim;
}
//-----------------------------------------------------------------------
